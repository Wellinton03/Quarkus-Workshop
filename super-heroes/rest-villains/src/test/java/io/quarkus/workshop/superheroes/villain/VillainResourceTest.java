...
public class VillainResourceTest {
    ...
    public void testHelloEndpoint() {
        given().header( ACCEPT, TEXT_PLAIN ).when().get( "/api/villains/hello" ).then()
            .statusCode( 200 ).body( is( "Hello Villain Resource" ) );
    }
    ...
    void shouldGetRandomVillain() {
        given().when().get( "/api/villains/random" ).then().statusCode( OK.getStatusCode() )
